        ...
        <div>
            ...
            <div class="extender">
                <table class="extender">
                    <tr>
                        <th>ID:
                            <asp:Label ID="lb_IdIncidencia" runat="server" Text=""></asp:Label></th>
                        <th>
                            <asp:Label ID="lbCategoria" runat="server" Text=""></asp:Label></th>
                        <th>
                            <asp:Label ID="lbPrioridad" runat="server" Text=""></asp:Label></th>
                        <th>
                            <asp:Label ID="lbEstado" runat="server" Text=""></asp:Label></th>
                        <th>
                            <asp:Label ID="lbInformador" runat="server" Text=""></asp:Label></th>

                    </tr>
                    <tr>
                        <th>
                            <asp:Label ID="lbResponsable" runat="server" Text=""></asp:Label></th>
                        <th>
                            <asp:Label ID="lbFechaActualizacion" runat="server" Text=""></asp:Label></th>
                        <th>
                            <asp:Label ID="lbProyecto" runat="server" Text=""></asp:Label></th>
                        <th>
                            <asp:Label ID="lbFechaCreacion" runat="server" Text=""></asp:Label></th>
                        <th></th>
                    </tr>
                </table>
            </div>
                ...
                <table class="extender">
                    <tr>
                        <th style="width: 250px">
                            <asp:Label ID="lbMotivo" runat="server" Text="&nbsp;Motivo: "></asp:Label></th>
                        <td>
                            <asp:TextBox ID="tbMotivo" ReadOnly="True" runat="server" TextMode="SingleLine" Enabled="False" Width="100%" /></td>
                    </tr>
                    <tr>
                        <th>
            ...
            <div class="extender">
                <table class="extender">
                    <tr>
                        <th>
                            <asp:Label ID="lbNota" runat="server" Text="Nota: "></asp:Label></th>
                        <td>
                            <asp:TextBox ID="tbNota" runat="server" TextMode="MultiLine" Height="130px" Width="800px" class="extender" /></td>
                    </tr>
                    <tr>
                        <th></th>
                        <th>
                            <asp:Button ID="btAgregar" runat="server" Text="Agregar nota" Width="116px" OnClick="AgregarNota" /></th>
                    </tr>
                </table>
            </div>
