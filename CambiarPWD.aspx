        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" Height="320px" Style="margin-left: auto; margin-right: auto; background-color: #FFFFCC; border: thin double #808080" Width="450px">
                ...
                <div style="width: fit-content">
                    &nbsp;<img src="Resources/Images/SplashBT_Logo.png" alt="Splash Logo" style="margin-left: 100px;" />
                </div>
                <table style="position: relative; margin-left: auto; margin-right: auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="tbAntigua" runat="server" TextMode="Password" placeholder="password antigua"></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btCambiar" runat="server" Text="Cambiar contraseña" OnClick="CambiarPassword" Width="140px" /></td>
                        <td>
                            <asp:Button ID="btVolver" runat="server" Text="Volver" OnClick="Volver" Width="100px" /></td>
                    </tr>
                </table>
                <div style="margin-left: 15px; margin-top: 10px">
                    <asp:Label ID="lbError" runat="server" Text="Error al actualizar" Visible="False" ForeColor="Red"></asp:Label></div>
            </asp:Panel>
        </div>
    </form>
</body>
